...
inline void AciDescriptionReaderErrorHandler::reportParseException(const xercesc::SAXParseException &ex) {
...
inline void AciDescriptionReaderErrorHandler::warning(const xercesc::SAXParseException &ex) {
    reportParseException(ex);
}

inline void AciDescriptionReaderErrorHandler::error(const xercesc::SAXParseException &ex) {
    reportParseException(ex);
}

inline void AciDescriptionReaderErrorHandler::fatalError(const xercesc::SAXParseException &ex) {
    reportParseException(ex);
}

inline void AciDescriptionReaderErrorHandler::resetErrors() {
}



inline std::shared_ptr<SlaveDescription_t> readSlaveDescription(const char *acuDFile) {
